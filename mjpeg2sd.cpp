...
int moveStartChecks = 1; // checks per second for start motion 
int moveStopSecs = 5; // secs between each check for stop, also determines post motion time
...
uint8_t minSeconds = 10; // default min video length (includes POST_MOTION_TIME)
